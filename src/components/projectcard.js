    ...
    return (<div className='Projectcard'>
        <div className="Projectcardmain">
            ...
            <div className='Project-card-hover'>
                ...
                <button className={`vote-button upvot ${upvoted? 'upvoted':''}`} onClick={upvote}  >
                        <i className="fas fa-arrow-up"></i>
                    </button>
                    <span className='vote-count'>{vote}</span> {/* Placeholder for vote count */}
                    <button className={`vote-button downvote ${downvoted? 'upvoted':''}`} onClick={downvote}>
